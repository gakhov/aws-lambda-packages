...
static PyUFuncGenericFunction greater_functions[] = {BOOL_greater, BYTE_greater, UBYTE_greater, SHORT_greater, USHORT_greater, INT_greater, UINT_greater, LONG_greater, ULONG_greater, LONGLONG_greater, ULONGLONG_greater, HALF_greater, FLOAT_greater, DOUBLE_greater, LONGDOUBLE_greater, CFLOAT_greater, CDOUBLE_greater, CLONGDOUBLE_greater, OBJECT_greater, DATETIME_greater, TIMEDELTA_greater, OBJECT_OO_O_greater};
static void * greater_data[] = {(void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL};
...
static PyUFuncGenericFunction less_functions[] = {BOOL_less, BYTE_less, UBYTE_less, SHORT_less, USHORT_less, INT_less, UINT_less, LONG_less, ULONG_less, LONGLONG_less, ULONGLONG_less, HALF_less, FLOAT_less, DOUBLE_less, LONGDOUBLE_less, CFLOAT_less, CDOUBLE_less, CLONGDOUBLE_less, OBJECT_less, DATETIME_less, TIMEDELTA_less, OBJECT_OO_O_less};
static void * less_data[] = {(void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL};
...
static PyUFuncGenericFunction not_equal_functions[] = {BOOL_not_equal, BYTE_not_equal, UBYTE_not_equal, SHORT_not_equal, USHORT_not_equal, INT_not_equal, UINT_not_equal, LONG_not_equal, ULONG_not_equal, LONGLONG_not_equal, ULONGLONG_not_equal, HALF_not_equal, FLOAT_not_equal, DOUBLE_not_equal, LONGDOUBLE_not_equal, CFLOAT_not_equal, CDOUBLE_not_equal, CLONGDOUBLE_not_equal, OBJECT_not_equal, DATETIME_not_equal, TIMEDELTA_not_equal, OBJECT_OO_O_not_equal};
static void * not_equal_data[] = {(void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL};
...
InitOperators(PyObject *dictionary) {
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[1] = BYTE_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[2] = UBYTE_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[3] = SHORT_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[4] = USHORT_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[5] = INT_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[6] = UINT_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[7] = LONG_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[8] = ULONG_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[9] = LONGLONG_negative_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        negative_functions[10] = ULONGLONG_negative_avx2;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[1] = BYTE_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[2] = UBYTE_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[3] = SHORT_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[4] = USHORT_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[5] = INT_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[6] = UINT_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[7] = LONG_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[8] = ULONG_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[9] = LONGLONG_subtract_avx2;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX2
    if (npy_cpu_supports("avx2")) {
        subtract_functions[10] = ULONGLONG_subtract_avx2;
    }
    #endif
    ...
    f = PyUFunc_FromFuncAndData(
        ...
        2, 1, PyUFunc_MinusOne, "bitwise_and",
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        ceil_functions, ceil_data, ceil_signatures, 5,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        equal_functions, equal_data, equal_signatures, 22,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        exp_functions, exp_data, exp_signatures, 8,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        floor_functions, floor_data, floor_signatures, 5,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        floor_divide_functions, floor_divide_data, floor_divide_signatures, 20,
    ...
    f = PyUFunc_FromFuncAndData(
        ...
        2, 1, PyUFunc_Zero, "gcd",
        "Returns the greatest common divisor of ``|x1|`` and ``|x2|``\n""\n""Parameters\n""----------\n""x1, x2 : array_like, int\n""    Arrays of values\n""\n""Returns\n""-------\n""y : ndarray or scalar\n""    The greatest common divisor of the absolute value of the inputs\n""    This is a scalar if both `x1` and `x2` are scalars.\n""\n""See Also\n""--------\n""lcm : The lowest common multiple\n""\n""Examples\n""--------\n"">>> np.gcd(12, 20)\n""4\n"">>> np.gcd.reduce([15, 25, 35])\n""5\n"">>> np.gcd(np.arange(6), 20)\n""array([20,  1,  2,  1,  4,  5])", 0
    );
    if (f == NULL) {
        return -1;
    }
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        greater_functions, greater_data, greater_signatures, 22,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        greater_equal_functions, greater_equal_data, greater_equal_signatures, 22,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        isfinite_functions, isfinite_data, isfinite_signatures, 7,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        isinf_functions, isinf_data, isinf_signatures, 7,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        isnan_functions, isnan_data, isnan_signatures, 7,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        less_functions, less_data, less_signatures, 22,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        less_equal_functions, less_equal_data, less_equal_signatures, 22,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        log_functions, log_data, log_signatures, 8,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        negative_functions, negative_data, negative_signatures, 20,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        not_equal_functions, not_equal_data, not_equal_signatures, 22,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        remainder_functions, remainder_data, remainder_signatures, 15,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        rint_functions, rint_data, rint_signatures, 8,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        sqrt_functions, sqrt_data, sqrt_signatures, 11,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        subtract_functions, subtract_data, subtract_signatures, 22,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        trunc_functions, trunc_data, trunc_signatures, 5,
